...
public class Product {
  ...
  public void cg_init_Product_2(final String n, final Number p, final Number s, final Number d) {
  ...
  public void cg_init_Product_1(final String n, final Number p) {
  ...
  public Product(final String n, final Number p) {

    cg_init_Product_1(n, p);
  }

  public Product(final String n, final Number p, final Number s, final Number d) {

    cg_init_Product_2(n, p, s, d);
  }
